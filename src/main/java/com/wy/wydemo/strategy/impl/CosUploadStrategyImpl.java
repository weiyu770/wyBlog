...
import com.wy.wydemo.config.properity.CosProperties;
import com.wy.wydemo.service.impl.AbstractUploadStrategyImpl;
...
/**
 * @description: 腾讯云cos上传策略
 * @class: CosUploadStrategyImpl
 * @author: yu_wei
 * @create: 2024/11/06 00:37
 */
@Slf4j
...
public class CosUploadStrategyImpl extends AbstractUploadStrategyImpl {
    ...
    public String getFileAccessUrl(String filePath) {
        // 确保返回的 URL 以 https:// 开头，并正确拼接 path 和 filePath
        return "https://" + cosProperties.getUrl() + "/" + filePath;
    }
