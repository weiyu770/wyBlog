...
import com.wy.wydemo.aop.PageableInterceptor;
...
import static com.wy.wydemo.model.enums.StatusCodeEnum.UNAUTHORIZED;

/**
 * @description: SaToken配置
 * @class: SaTokenConfig
 * @author: yu_wei
 * @create: 2024/11/04 17:00
 */
@Slf4j
@Component
    ...
    public SaServletFilter getSaServletFilter() {
        return new SaServletFilter()
                ...
                .setAuth(obj -> {
                    ...
                    log.debug("Current token timeout: " + tokenTimeout);
                    
                    if (tokenTimeout < timeout) {
                        log.debug("Renewing token timeout to 1800 seconds.");
                ...
                .setError(e -> {
                    ...
                    if (e instanceof NotLoginException) {
                        return JSONUtil.toJsonStr(Result.fail(UNAUTHORIZED.getCode(), UNAUTHORIZED.getMessage()));
                    }
